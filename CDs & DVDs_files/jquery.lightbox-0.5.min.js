 ...
 */
(function($){$.fn.lightBox=function(settings){settings=jQuery.extend({overlayBgColor:'#000',overlayOpacity:0.8,fixedNavigation:false,imageLoading:'templates/creator/images/lightbox-ico-loading.gif',imageBtnPrev:'templates/creator/images/lightbox-btn-prev.gif',imageBtnNext:'templates/creator/images/lightbox-btn-next.gif',imageBtnClose:'templates/creator/images/lightbox-btn-close.gif',imageBlank:'templates/creator/images/lightbox-blank.gif',containerBorderSize:10,containerResizeSpeed:400,txtImage:'Image',txtOf:'of',keyToClose:'c',keyToPrev:'p',keyToNext:'n',widthImage:2000,heightImage:2000,imageArray:[],activeImage:0},settings);var jQueryMatchedObj=this;function _initialize(){_start(this,jQueryMatchedObj);return false;}
